...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/me/index.vue */ 67));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_373b9194___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=373b9194& */ 68);
...
var _default =
{
  ...
  methods: {
    getUser: function getUser(userInfo) {
      var that = this;
      var access_token = uni.getStorageSync('access_token');
      this.api.user.getUserInfo(access_token, userInfo).then(function (res) {
              ...
              success: function success(loginRes) {
                ...
                uni.getUserInfo({
                  ...
                  success: function success(userInfoRes) {
                    if (code !== undefined) {
                      that.api.user.login(code).then(function (res) {
                        console.log(res);
