...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/productInfo/index.vue */ 59));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_1b3f8757___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=1b3f8757& */ 60);
...
try {
  components = {
    ...
    uPopup: function() {
      return __webpack_require__.e(/*! import() | uview-ui/components/u-popup/u-popup */ "uview-ui/components/u-popup/u-popup").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-popup/u-popup.vue */ 167))
    }
  }
} catch (e) {
  if (
...
var _default =
{
  ...
  methods: {
    showResumeList: function showResumeList() {
      this.getResumeList();
      this.resumeShow = true;
    },
    getResumeList: function getResumeList() {var _this = this;
      this.api.user.getResumeList().then(function (res) {
        if (res.statusCode === 200) {
          _this.resumeList = res.data.resume;
        } else {
          uni.showToast({
            title: '请先上传简历',
            icon: 'none' });
    ...
    sendResume: function sendResume(resumeId) {var _this2 = this;
      var data = {
        resumeId: resumeId,
        positionId: this.productInfo.id };

      this.api.user.sendResume(data).then(function (res) {
        if (res.statusCode === 200) {
          uni.showToast({
            title: '投递成功',
            icon: 'success' });

          _this2.resumeShow = false;
        } else {
          uni.showToast({
    ...
    goCompanyInfo: function goCompanyInfo(companyId) {
      uni.navigateTo({
        url: "../companyInfo/index?companyId=".concat(companyId) });

    },
    getProductInfo: function getProductInfo(id) {
      var that = this;
      this.api.company.getPositionInfo(id).then(function (res) {
        if (res.statusCode === 200) {
